...
// Nota: la spec original menciona "pago mínimo" como opción, pero el modelo de
// datos no guarda un monto mínimo por tarjeta — solo ofrecemos "pago total" y
// "otro monto" (no inventamos un número de mínimo que no existe en el backend).
//
// A diferencia del sheet móvil (que recibía cycleId/remaining/allocated como
...
const radioDotStyle: React.CSSProperties = { width: 10, height: 10, borderRadius: 5, background: colors.accent };
const sourceChipStyle: React.CSSProperties = { padding: `${spacing.md}px ${spacing.md}px`, borderRadius: radius.pill, background: colors.surface };
