...
export default function AccountFormPage() {
  ...
  return (
    <PageShell>
      ...
      <PrimaryButton label={isEditing ? 'Guardar cambios' : 'Guardar cuenta'} onPress={handleSave} disabled={!canSave} loading={saving} style={styles.saveBtn} />
      {isEditing ? <DangerButton label="Eliminar cuenta" onPress={handleDelete} loading={deleting} style={styles.deleteBtn} /> : null}
    </PageShell>
  );
}
